                ...
                <div className="max-w-6xl mx-auto">
                    ...
                    >
                        <h1 className="font-heading text-5xl md:text-7xl font-bold text-white uppercase tracking-tighter leading-none">
                            Training <span className="text-yellow-400">Ground</span>
                        </h1>
                    </motion.div>
                    ...
                    >
                        {/* The Schedule Module */}
                        <motion.div variants={item} className="bg-zinc-950 border-2 border-zinc-800 p-8 md:p-10 relative group hover:border-yellow-500 transition-colors">
                            ...
                            <div className="space-y-6 relative z-10">
                                <div className="border-b border-zinc-800 pb-4">
                                    <div className="flex justify-between items-end mb-2">
                                        ...
                                        <span className="text-yellow-400 font-heading text-2xl">18:00 - 21:00</span>
                                    </div>
                        ...
                        {/* The Location Module */}
                        <motion.div variants={item} className="bg-zinc-950 border-2 border-zinc-800 p-8 md:p-10 relative group hover:border-yellow-500 transition-colors flex flex-col">
                            <div className="absolute top-0 right-0 p-4 opacity-5 group-hover:opacity-10 transition-opacity pointer-events-none">
                                <MapPin size={100} className="text-yellow-500" />
                            </div>
                            ...
                            <div className="flex-grow flex flex-col justify-between relative z-10">
                                <div className="mb-6">
                                    ...
                                    <p className="text-yellow-400 font-heading text-xl tracking-wider mb-2">44137 DORTMUND</p>
                                ...
                                <a
                                    ...
                                    className="w-full h-32 bg-black border border-zinc-800 relative overflow-hidden flex items-center justify-center group/map hover:border-yellow-500 transition-colors cursor-pointer"
                                >
                                    ...
                                    <div className="absolute w-full h-[1px] bg-yellow-500/20 top-1/2 -translate-y-1/2 shadow-[0_0_10px_rgba(234,179,8,0.5)]"></div>
                                    <div className="absolute h-full w-[1px] bg-yellow-500/20 left-1/2 -translate-x-1/2 shadow-[0_0_10px_rgba(234,179,8,0.5)]"></div>

                                    {/* Icon that scales up slightly on hover to indicate it's clickable */}
                                    <Crosshair className="w-6 h-6 text-yellow-400 absolute z-10 animate-pulse group-hover/map:scale-125 transition-transform" />

                                    {/* Updated with the exact coordinates */}
                                    <span className="absolute bottom-2 right-2 text-zinc-600 font-heading text-xs tracking-widest group-hover/map:text-yellow-500 transition-colors">
                    COORD: 51.5037° N, 7.4369° E
                  </span>

                                    {/* Hover prompt */}
                                    <div className="absolute inset-0 bg-yellow-500/10 opacity-0 group-hover/map:opacity-100 transition-opacity flex items-center justify-center">
                    <span className="bg-black text-yellow-400 px-3 py-1 font-bold text-xs uppercase tracking-widest border border-yellow-500/50 relative z-20">
                      OPEN IN MAPS
                    </span>
                                    </div>
                                </a>
